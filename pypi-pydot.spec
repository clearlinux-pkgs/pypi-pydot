...
Source0  : https://files.pythonhosted.org/packages/bf/b8/500a772825c7ca87e4fd69c3bd6740e3375d6792a7065dd92759249f223d/pydot-3.0.3.tar.gz
...
%prep
%setup -q -n pydot-3.0.3
cd %{_builddir}/pydot-3.0.3
pushd ..
cp -a pydot-3.0.3 buildavx2
popd
pushd ..
cp -a pydot-3.0.3 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733167619
