...
Source0  : https://files.pythonhosted.org/packages/50/35/b17cb89ff865484c6a20ef46bf9d95a5f07328292578de0b295f4a6beec2/pydot-4.0.1.tar.gz
...
%prep
%setup -q -n pydot-4.0.1
cd %{_builddir}/pydot-4.0.1
pushd ..
cp -a pydot-4.0.1 buildavx2
popd
pushd ..
cp -a pydot-4.0.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750253862
