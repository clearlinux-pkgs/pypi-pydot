...
Source0  : https://files.pythonhosted.org/packages/d1/c3/6034ed1ebf2e3ba95a0e35fa7c43104e40444c0ed2b5325702c63e824dbf/pydot-4.0.0.tar.gz
...
%prep
%setup -q -n pydot-4.0.0
cd %{_builddir}/pydot-4.0.0
pushd ..
cp -a pydot-4.0.0 buildavx2
popd
pushd ..
cp -a pydot-4.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746458992
