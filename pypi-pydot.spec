...
Source0  : https://files.pythonhosted.org/packages/2c/aa/4cf0b17a070fb57798e8e0f5b1665abf5b2f19ee8ea47957aec2c37b9ced/pydot-3.0.1.tar.gz
...
%prep
%setup -q -n pydot-3.0.1
cd %{_builddir}/pydot-3.0.1
pushd ..
cp -a pydot-3.0.1 buildavx2
popd
pushd ..
cp -a pydot-3.0.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721145374
